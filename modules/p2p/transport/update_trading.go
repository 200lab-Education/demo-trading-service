...
func UpdateTrading(sc goservice.ServiceContext, status string) func(*gin.Context) {
	return func(c *gin.Context) {
		...
		if err := business.UpdateTrading(c.Request.Context(), int(id.GetLocalID()), &data); err != nil {
			panic(err)
		}

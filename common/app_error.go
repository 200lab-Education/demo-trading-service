...
func ValidateError(msg, key string) *AppError { return NewCustomError(nil, msg, key) }
...
func ErrEntityNil(entity string) error {
	return errors.New(fmt.Sprintf("%s is nil", entity))
}

var (
	ErrEnoughAmount = ValidateError("not enough amount", "ErrEnoughAmount")
)
